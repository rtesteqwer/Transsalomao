...
// Compatibilidade visual/estrutural apenas: não há autenticação biométrica,
// WebAuthn, pedido de digital, Face ID ou chamada à bridge nativa neste gate.
...
// A biblioteca legada fica apenas porque owner/shell ainda importa o helper de
// chave de sessão. Como o gate não importa os métodos de autenticação, o bundler
// elimina o código WebAuthn não usado. As bridges nativas são removidas.
for (const rel of [
