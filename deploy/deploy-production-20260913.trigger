...
validation: only automatic ticket calculation differs from last known-good source; query keeps existing numeric SQL typing while using highest existing ticket/code
