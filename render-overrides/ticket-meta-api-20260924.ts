    ...
    GET: async ({ request }) => {
      ...
      return json({
        ...
        ticket: {
          ...
          cliente: (row.ticket_data as Record<string, unknown> | null)?.cliente || null,
          produto: (row.ticket_data as Record<string, unknown> | null)?.produto || null,
          remetente: (row.ticket_data as Record<string, unknown> | null)?.remetente || null,
          navio: (row.ticket_data as Record<string, unknown> | null)?.navio || null,
          navioOrigem: (row.ticket_data as Record<string, unknown> | null)?.navio_origem || null,
          navioDestino: (row.ticket_data as Record<string, unknown> | null)?.navio_destino || null,
