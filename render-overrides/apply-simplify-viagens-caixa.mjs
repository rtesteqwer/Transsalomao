...
// VIAGENS: Caixinha e Cegonha ficam agrupadas visualmente. Os dados originais
// continuam intactos e os grupos podem ser selecionados para ações em lote.
{
...
console.log('[simplify-viagens-caixa] Caixinha/Cegonha grouped in Viagens + Caixa driver filter applied');
